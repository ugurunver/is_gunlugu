...
$stok_ekle = $('#stok-ekle').attr( "href" );
$musteri_ekle = $('#musteri-ekle').attr( "href" );
$fatura_olustur = $('#fatura-olustur').attr( "href" );
$gelen_faturalar = $('#gelen-faturalar').attr( "href" );
$giden_faturalar = $('#giden-faturalar').attr( "href" );
$.key('shift+1', function() {
    window.location = $base_url+$musteri_ekle;
});
$.key('shift+2', function() {
    window.location = $base_url+$stok_ekle;
});
$.key('f7', function() {
    window.location = $base_url+$fatura_olustur;
});
$.key('f9', function() {
    window.location = $base_url+$gelen_faturalar;
});
$.key('f8', function() {
    window.location = $base_url+$giden_faturalar;
});
$.key('f4', function() {
    $(".hizli-submit").click();
});
